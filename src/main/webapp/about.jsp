...
<body class="container-fluid"
	style="background-color: #f1f8e9; font-style: inherit; color: rgb(99, 118, 84);margin:0px;padding:0px">
	<%@ include file="header.jsp"%>
	<div class="container-fluid my-4">
		<div
			class="row featurette d-flex justify-content-center align-items-center">
			<div class="col-6">
				<h1 class="featurette-heading">About EventCraft</h1>
				<p>At EventCraft, we are passionate about creating
		...
		<div
			...
			<div class="col-6 order-2">
				...
				<p>At EventCraft, our vision is to be the premier provider of
