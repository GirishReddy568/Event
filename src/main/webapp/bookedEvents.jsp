		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="container-fluid"
					style="background-color: #648256; width: 1360px; height: 67px; margin-left: -23px; margin-top: -20px; font-style: inherit; color: white;">
					<div class="row">
						<div class="col-sm-4">
				...
				<table class="table table-striped table-hover" style="width:98%; text-align: center;">
					<thead>
						<tr>
							<th>Image</th>
							<th>Name</th>
					...
					<tbody>
						...
						%>
						<tr>
							<td><img src=" images/<%=s.getP_image()%>" width="100px"
								height="100px"></td>
							<td><%=s.getP_name()%></td>
							<td><%=s.getP_cost()%></td>
							<td><%=s.getEmail()%></td>
